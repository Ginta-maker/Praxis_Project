...
export default class Monatslistensammlung {
    ...
    _eintrag_hinzufuegen(eintrag) {
        let eintragsmonat = eintrag.datum().toLocaleDateString('de-DE', {month: 'numeric'});
        let eintragsjahr = eintrag.datum().toLocaleDateString('de-DE', {year: 'numeric'});
    ...
    /**
     * Diese private Methode entfernt eine bereits bestehende Monatslistesammlung, wenn vorhanden.
     */
    _entfernen() {
    ...
    /**
     * Diese Methode zeigt die generierte Monatslistesammlung an der richtigen Stelle in der UI an. 
     */
    anzeigen() {
