...
export default class Eingabeformular {
     ...
     * @prop {Element} _html - das HTML des Eingabeformular
     */
    constructor() {
    ...
    /**
     * Diese private Methode extrahiert die im Eingabeformular eigegebenen Daten aus
     * dem Submit-Event des Eingabeformulars.
     * @param {Event} submit_event - das Submit-Event des Eingabeformulars 
     * @returns {Object} - einfaches Object mit den Rohdaten des Eingabeformulars
     */
    ...
    _absenden_event_hinzufuegen(eingabeformular) {
        eingabeformular.querySelector('#eingabeformular').addEventListener('submit', e => {
            ...
            if (formular_fehler.length === 0) {
                ...
                let fehler = new Fehlerbox('Flgende Felder wurden nicht korrekt ausgefüllt:', formular_fehler);
                fehler.anzeigen();
            }
        });
    }
