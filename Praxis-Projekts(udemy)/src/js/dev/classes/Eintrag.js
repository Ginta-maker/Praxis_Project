/**
 * Das Modul 'Eintrag' stellt die Klassen 'Eintrag' zur Verfügung.
...
/**
 * Die Klasses 'Eintrag' stellt alle Eigenschaften
 * und Methoden eines Eintrags (inkl. HTML und Event) zur Verfügung.
 */
export default class Eintrag {

    /**
     * Der Konstruktor generiert bei Instanziierung der Klasses 'Eintrag'
     * anhand der u.g. Parameter ein Eintrag-Objekt mit gen u.g. Eigenschaften.
    ...
    /**
     * Getter-Methode für den HTML des Eintrags.
     * @return {Element} - der HTML des Eintrags
     */
    html() {
        return this._html;
    }
